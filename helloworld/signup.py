...
class SignupHandler(Handler):
    def render_signup(self, username="", email="", nameerror="", conflicterror = "", passerror="", verifyerror="", emailerror=""):
        self.render("signup.html", username = username, email = email, nameerror = nameerror, conflicterror = conflicterror, passerror = passerror, verifyerror = verifyerror, emailerror = emailerror)
